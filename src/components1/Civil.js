  ...
  return (
    <div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gridGap: '30px' }}>
        ...
        <div style={{ marginTop: '30px' }}>
          <label className='label' style={{ marginRight: '20px' }}>Section 2: Structural Engineering</label>
          <input style={{ width: '100%', padding: '0.5rem', border: ' 1px solid #ccc', borderRadius: '4px' }} type='number' />
        </div>

        <div style={{ marginTop: '30px' }} >
          <label className='label' style={{ marginRight: '20px' }}>Section 3:  Geotechnical Engineering</label>
          <input style={{ width: '100%', padding: '0.5rem', border: ' 1px solid #ccc', borderRadius: '4px' }} type='number' />
        </div>

        <div style={{ marginTop: '30px' }}>
          <label className='label' style={{ marginRight: '20px' }}>Section 4: Water Resources Engineering</label>
          <input style={{ width: '100%', padding: '0.5rem', border: ' 1px solid #ccc', borderRadius: '4px' }} type='number' />
        </div>

        <div style={{ marginTop: '30px' }}>
          <label className='label' style={{ marginRight: '20px' }}>Section 5: Environmental Engineering</label>
          <input style={{ width: '100%', padding: '0.5rem', border: ' 1px solid #ccc', borderRadius: '4px' }} type='number' />
        </div>

        <div style={{ marginTop: '30px' }}>
          <label className='label' style={{ marginRight: '20px' }}>Section 6:  Transportation Engineering </label>
          <input style={{ width: '100%', padding: '0.5rem', border: ' 1px solid #ccc', borderRadius: '4px' }} type='number' />
        </div>

        <div style={{ marginTop: '30px' }}>
          <label className='label' style={{ marginRight: '20px' }}>Section 7: Geomatics Engineering</label>
          <input style={{ width: '100%', padding: '0.5rem', border: ' 1px solid #ccc', borderRadius: '4px' }} type='number' />
        </div>
