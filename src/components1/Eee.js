  ...
  return (
    <div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gridGap: '30px' }}>
        ...
        <div style={{ marginTop: '30px' }}>
          <label className='label' style={{ marginRight: '20px' }}>Section 2: Electric circuits</label>
          <input style={{ width: '100%', padding: '0.5rem', border: ' 1px solid #ccc', borderRadius: '4px' }} type='number' />
        </div>

        <div style={{ marginTop: '30px' }} >
          <label className='label' style={{ marginRight: '20px' }}>Section 3: Electromagnetic Fields</label>
          <input style={{ width: '100%', padding: '0.5rem', border: ' 1px solid #ccc', borderRadius: '4px' }} type='number' />
        </div>

        <div style={{ marginTop: '30px' }}>
          <label className='label' style={{ marginRight: '20px' }}>Section 4: Signals and Systems</label>
          <input style={{ width: '100%', padding: '0.5rem', border: ' 1px solid #ccc', borderRadius: '4px' }} type='number' />
        </div>
